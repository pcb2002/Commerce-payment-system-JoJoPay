...
public enum ErrorCode {
    ...
    // 상태값(Status) 도메인 검증
    INVALID_CUSTOMER_STATUS(HttpStatus.BAD_REQUEST, "INVALID_CUSTOMER_STATUS", "유효하지 않은 고객 상태입니다."),
    ...
    CUSTOMER_SUSPENDED(HttpStatus.FORBIDDEN, "CUSTOMER_SUSPENDED", "활동이 정지된 회원 계정입니다."),
    ...
    CUSTOMER_NOT_FOUND(HttpStatus.NOT_FOUND, "CUSTOMER_NOT_FOUND", "고객이 존재하지 않습니다."),
    ...
    WALLET_NOT_FOUND(HttpStatus.NOT_FOUND, "WALLET_NOT_FOUND", "고객의 페이머니 지갑을 찾을 수 없습니다."),
    ...
    CUSTOMER_ALREADY_DELETED(HttpStatus.CONFLICT, "CUSTOMER_ALREADY_DELETED", "이미 탈퇴 또는 삭제 처리된 고객입니다."),
